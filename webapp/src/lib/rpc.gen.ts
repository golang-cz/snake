...
export const WebRPCSchemaHash = '23da2b4947ef517e519e579f85d4618609d9bd42';
...
export class InvalidTurnError extends WebrpcError {
	constructor(
		name: string = 'InvalidTurn',
		code: number = 101,
		message: string = `Can't reverse direction.`,
		status: number = 0,
		cause?: string
	) {
		super(name, code, message, status, cause);
		Object.setPrototypeOf(this, InvalidTurnError.prototype);
	}
}
