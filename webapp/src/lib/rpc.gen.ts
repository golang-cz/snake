/* eslint-disable */
// snake v1.0.0 4b39bab532cde9335759576c8b44254075bd954b
// --
...
export const WebRPCSchemaHash = "4b39bab532cde9335759576c8b44254075bd954b"
...
export interface Snake {
  ...
  body: Array<Square>
  direction: Direction
  nextDirections: Array<Direction>
  length: number
  bornAt: string
  diedAt: string
}
...
export interface SnakeGame {
  ...
  createSnake(args: CreateSnakeArgs, headers?: object, signal?: AbortSignal): Promise<CreateSnakeReturn>
  turnSnake(args: TurnSnakeArgs, headers?: object, signal?: AbortSignal): Promise<TurnSnakeReturn>
}
...
export class SnakeGame implements SnakeGame {
  ...
  joinGame = (options: WebrpcStreamOptions<JoinGameReturn>): Promise<void> => {
    const _fetch = () => this.fetch(this.url('JoinGame'),createHTTPRequest({}, options.headers, options.signal)
      ).then(async (res) => {
  ...
  createSnake = (args: CreateSnakeArgs, headers?: object, signal?: AbortSignal): Promise<CreateSnakeReturn> => {
    return this.fetch(
      this.url('CreateSnake'), createHTTPRequest(args, headers, signal)).then((res) => {
  ...
  turnSnake = (args: TurnSnakeArgs, headers?: object, signal?: AbortSignal): Promise<TurnSnakeReturn> => {
    return this.fetch(
      this.url('TurnSnake'), createHTTPRequest(args, headers, signal)).then((res) => {
        return buildResponse(res).then(_data => {
          return {}
          })}, (error) => {throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error.message || ''}` })}
      )
...
export class SnakeNotFoundError extends WebrpcError {
  constructor(
    name: string = 'SnakeNotFound',
    code: number = 100,
    message: string = 'Snake not found.',
    status: number = 0,
    cause?: string
  ) {
    super(name, code, message, status, cause)
    Object.setPrototypeOf(this, SnakeNotFoundError.prototype)
  }
}

export class InvalidInputError extends WebrpcError {
  constructor(
    name: string = 'InvalidInput',
    code: number = 101,
...
export class TurnAboutError extends WebrpcError {
  constructor(
    name: string = 'TurnAbout',
    code: number = 200,
    message: string = 'Turnabout is not allowed.',
    status: number = 0,
    cause?: string
  ) {
    super(name, code, message, status, cause)
    Object.setPrototypeOf(this, TurnAboutError.prototype)
  }
}

export class TurnSameDirectionError extends WebrpcError {
  constructor(
    name: string = 'TurnSameDirection',
    code: number = 201,
    message: string = 'Duplicated turn. Same direction.',
    status: number = 0,
    cause?: string
  ) {
    super(name, code, message, status, cause)
    Object.setPrototypeOf(this, TurnSameDirectionError.prototype)
  }
}
...
export enum errors {
  ...
  SnakeNotFound = 'SnakeNotFound',
  InvalidInput = 'InvalidInput',
  TurnAbout = 'TurnAbout',
  TurnSameDirection = 'TurnSameDirection',
}
...
const webrpcErrorByCode: { [code: number]: any } = {
  ...
  [100]: SnakeNotFoundError,
  [101]: InvalidInputError,
  [200]: TurnAboutError,
  [201]: TurnSameDirectionError,
}
