...
func WebRPCSchemaHash() string {
	return "508dedc89337da00dbd6622fe89442e076f73327"
}
...
type JoinGameStreamWriter interface {
	Write(update *Update, event *Event) error
}
...
func (w *joinGameStreamWriter) Write(update *Update, event *Event) error {
	out := struct {
		Ret0 *Update `json:"update"`
...
type JoinGameStreamReader interface {
	Read() (update *Update, event *Event, err error)
}
...
func (s *snakeGameServer) serveJoinGameNDJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (r *joinGameStreamReader) Read() (*Update, *Event, error) {
	out := struct {
		Ret0 *Update `json:"update"`
		Ret1 *Event `json:"event"`
		WebRPCError *WebRPCError `json:"webrpcError"`
...
var (
	...
	ErrInvalidInput = WebRPCError{Code: 101, Name: "InvalidInput", Message: "Invalid input.", HTTPStatus: 400}
	ErrTurnAbout = WebRPCError{Code: 200, Name: "TurnAbout", Message: "Turnabout is not allowed.", HTTPStatus: 400}
	ErrTurnSameDirection = WebRPCError{Code: 201, Name: "TurnSameDirection", Message: "Duplicated turn. Same direction.", HTTPStatus: 400}
)
